...
$routes->group('api', ['namespace' => 'App\Controllers\Api', 'filter' => 'apiAuth'], function ($routes) {
    ...
    // Ligo Payment Routes - Único punto de entrada para QR
    $routes->match(['get', 'options'], 'payments/generate-qr/(:num)', 'LigoPaymentController::generateQR/$1');
    $routes->match(['get', 'options'], 'payments/generate-instalment-qr/(:num)', 'LigoPaymentController::generateInstalmentQR/$1');
    $routes->match(['get', 'options'], 'payments/generate-static-qr/(:segment)', 'LigoPaymentController::generateStaticQR/$1');
