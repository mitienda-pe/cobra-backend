...
class UserModel extends Model
{
    ...
    protected $validationRules      = [
        ...
        'email'    => 'required|valid_email|is_unique[users.email,deleted_at IS NOT NULL]',
        'phone'    => 'required|min_length[10]|is_unique[users.phone,deleted_at IS NOT NULL]',
    ...
    public function getValidationRulesForUpdate($id = null)
    {
        return [
            'name'     => 'required|min_length[3]|max_length[100]',
            'email'    => "required|valid_email|is_unique[users.email,id,{$id},deleted_at IS NOT NULL]",
            'phone'    => "required|min_length[10]|is_unique[users.phone,id,{$id},deleted_at IS NOT NULL]",
            'role'     => 'required|in_list[superadmin,admin,user]',
            'status'   => 'required|in_list[active,inactive]',
