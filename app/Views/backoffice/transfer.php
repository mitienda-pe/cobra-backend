        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Transferencia Ordinaria</h3>
                            ...
                            <div class="col-md-6">
                                ...
                                <?php else: ?>
                                    <div class="alert alert-warning">
                                        ...
                                        No hay configuración disponible. Configure las credenciales en
                                        <a href="<?= site_url('superadmin/ligo-config') ?>">Configuración</a>.
                                    </div>
                                <?php endif; ?>
                            </div>
