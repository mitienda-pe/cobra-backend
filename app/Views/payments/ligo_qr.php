                ...
                <div class="card-body text-center">
                    ...
                    <div id="qr-content" style="display: <?= isset($qr_image_url) && !empty($qr_image_url) ? 'block' : 'none' ?>;">
                        ...
                        <?php elseif (isset($qr_image_url) && !empty($qr_image_url)): ?>
                            ...
                            <p class="text-muted" id="qr-instructions">Escanea el código QR con tu aplicación de Ligo para realizar el pago</p>
    ...
    fetch(ajaxUrl)
        ...
        .then(data => {
            ...
            if (data.success && data.qr_image_url) {
                ...
                document.getElementById('qr-instructions').textContent = 'Escanea el código QR con tu aplicación de Ligo para realizar el pago';
