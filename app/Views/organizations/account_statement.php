                ...
                <div class="card-body">
                    ...
                    <?php if (isset($activeConfig) && $isSuperadmin): ?>
                        <div class="alert alert-info mb-3">
                            ...
                            <strong>Configuración QR activa:</strong>
                            ...
                            <small class="d-block mt-1">
                                Mostrando solo pagos QR de ambiente <strong><?= $isProduction ? 'PRODUCCIÓN' : 'DESARROLLO' ?></strong>
                            </small>
                        </div>
                    <?php endif; ?>
                                            ...
                                            <tbody>
                                                ...
                                                if (!empty($ligoPayments)) {
                                                    foreach ($ligoPayments as $payment) {
                                                        ...
                                                        $allMovements[] = [
                                                            'date' => $paymentDate,
                                                            'type' => 'Pago QR (' . $envLabel . ')',
                                                            'description' => 'Pago de cuota recibido via QR ' . $envDescription,
